...
export function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center group">
      {/* Tooltip on hover */}
      <span className="mr-3 px-3 py-1.5 rounded-xl bg-dark/90 text-white text-xs font-medium border border-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none shadow-lg whitespace-nowrap hidden sm:inline-block">
        Chat with Sirajul 👋
      </span>

      {/* Floating Glowing WhatsApp Button */}
      <a
        href={whatsappUrl}
        target="_blank"
